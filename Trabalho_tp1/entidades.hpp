 ...
 * @details Usam dominios para validar seus atributos e mantem as regras de negocio.
 * @{
 */
...
public:
     ...
     */
    Quarto() : numero(), capacidade(), valor(), ramal() {}
...
private:
    Codigo codigo;
    /**
     * Ponteiro nao-dono para o hospede que fez a reserva.
     * Pode ser nullptr; o container gerencia a validade.
     */
    Hospede* hospede;
    /**
     * Ponteiro nao-dono para o hotel da reserva.
     */
    Hotel*   hotel;
    /**
     * Ponteiro nao-dono para o quarto reservado.
     */
    Quarto*  quarto;
    /**
